# ============================================
# 🧠 RAG SYSTEM (Auto-load FAISS + Metadata + Auto-install)
# ============================================
...
RAG_OUTPUT_DIR = r"C:\Users\Kamalakar Dandu\Downloads\extractor\rag_output"

print("[INFO] Loading embedding model...")
embedder = SentenceTransformer(EMBED_MODEL)

# -------------------------------
# 🔹 Automatically Load FAISS Index + Metadata
# -------------------------------
...
# Take the first found index & metadata
